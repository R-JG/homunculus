...
^-  kook:neo
|%
++  state  pro/%homunculus-ego
++  poke   (sy %homunculus-session %homunculus-from-umbra %eyre-task ~)
++  kids
  ^-  kids:neo
  :+  ~  %y
  ^-  lads:neo
...
++  form
  ^-  form:neo
  |_  [bol=bowl:neo =aeon:neo =pail:neo]
  ++  init
    |=  pal=(unit pail:neo)
    ^-  (quip card:neo pail:neo)
    :_  homunculus-ego/!>(*ego)
    =/  =pith:neo  #/[p/our.bol]/$/eyre
    =/  =binding:eyre  [~ ~[%neo %homunculus]]
    =/  =req:eyre:neo  [%connect binding here.bol]
    :~  [pith %poke eyre-req/!>(req)]
        [(snoc here.bol %umbra) %make %umbra ~ ~]
    ==
  ++  poke
    ...
    ?+  sud  !!
      ::
        %homunculus-session  ::  ::  ::  ::  ::  session poke
      =/  ses  !<(session.homunculus-api vaz)
      =/  fon=fons  pith.src.bol
      =/  aru=(unit ara)  (~(get by arae.ego) fon)
      ?^  aru
        =/  gen=ara
          %:  geno
            ...
            ==
          ==
        :_  homunculus-ego/!>(ego(arae (~(put by arae.ego) fon gen)))
        ~
      ...
      ?~  roo  [~ homunculus-ego/!>(ego)]
      =/  mov=(unit loci)  (orno muri.gen u.roo)
      ?~  mov
        =/  bac=visa  (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~])))
        =:  cor.ego   +(cor.ego)
            arae.ego  (~(put by arae.ego) fon gen)
            aula.ego  (into aula.ego +(cor.ego) (silt ~[fon]))
            fons.ego  fon
          ==
        :_  homunculus-ego/!>(ego)
        ~
      ...
      =:  fons.ego  fon
          arae.ego  (~(put by arae.ego) fon gen)
          aula.ego
            %^  snap  aula.ego  cor.ego
            =+(^-((set fons) (snag cor.ego aula.ego)) (~(put in -) fon))
        ==
      :_  homunculus-ego/!>(ego)
      ~
      :: :_  ?:(p.luna [(levo our.bol) ~] ~)
      ...
      :: ==
      ::
        %homunculus-from-umbra  ::  ::  ::  ::  ::  menu poke
      =/  umb  !<(from-umbra.homunculus-umbra vaz)
      ?-  -.umb
        ::
          %session
        =/  gen=ara
          %:  geno
            ...
            ?~  -.p.umb  q.luna.ego
            %_  q.luna.ego
              rex   ?~  select-default.-.p.umb  rex.q.luna.ego
                    =|(dux -(avis select-default.-.p.umb))
              ales  ?^(hotkeys.-.p.umb (uro hotkeys.-.p.umb) ~)
            ==
          ==
        :_  homunculus-ego/!>(ego(q.luna gen))
        ~
        :: ?.  p.luna  ~
        :: :_  ~
        :: :*  %give  %fact  ~[/homunculus-http]  %json
        ...
        ::
          %change
        ?:  =(fons.ego p.umb)  [~ homunculus-ego/!>(ego)]
        =/  i
          =|  i=@
          |-  ^-  (unit @)
          ?~  aula.ego  ~
          ?:  (~(has in i.aula.ego) p.umb)
            [~ i]
          $(aula.ego t.aula.ego, i +(i))
        ?~  i  [~ homunculus-ego/!>(ego)]
        ?:  =(cor.ego u.i)
          =.  fons.ego  p.umb
          [~ homunculus-ego/!>(ego)]
          :: [[(levo our.bol) ~] homunculus-ego/!>(ego)]
        =:  fons.ego  p.umb
            cor.ego   u.i
          ==
        =/  aul=(list fons)  ~(tap in ^-((set fons) (snag cor.ego aula.ego)))
        =/  bac=visa  (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~])))
        :_  homunculus-ego/!>(ego)
        ~
        :: :~  :*  %give  %fact  ~[/homunculus-http]  %json
        ...
        ?~  i  !!
        ?.  =(cor.ego u.i)  !!
        ?:  |((gth n 1) =(1 (lent aula.ego)))
          =/  bac=visa  (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~])))
          =/  aru=(unit ara)  (~(get by arae.ego) p.umb)
          =/  aul=(set fons)  (~(del in (snag u.i aula.ego)) p.umb)
          =/  fonu=(unit fons)  ?^(aul [~ n.aul] ~)
          =:  aula.ego  (snap aula.ego cor.ego aul)
              fons.ego  ?^(fonu u.fonu *fons)
              arae.ego  (~(del by arae.ego) p.umb)
            ==
          :_  homunculus-ego/!>(ego)
          ~
          :: :~  :*  %give  %fact  ~[/homunculus-http]  %json
          ...
          :: ==
        =:  arae.ego  (~(del by arae.ego) p.umb)
            aula.ego  (oust [cor.ego 1] aula.ego)
            cor.ego   ?:(=(0 cor.ego) 0 (dec cor.ego))
          ==
        =/  bac=visa  (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~])))
        =/  aul=(set fons)  (snag cor.ego aula.ego)
        =/  fonu=(unit fons)  ?^(aul [~ n.aul] ~)
        =.  fons.ego  ?^(fonu u.fonu *fons)
        :_  homunculus-ego/!>(ego)
        ~
        ...
        :_  homunculus-ego/!>(ego(arae (~(put by arae.ego) fons.ego u.aru)))
        ~
        :: :~  :*  %give  %fact  ~[/homunculus-http]  %json
        ::         !>  ^-  json  :-  %s  %-  crip  %-  volo  ^-  lux  :-  %mor
        ::         :~  (supo dim ~ vis)
      ...
      ::
        %eyre-task  ::  ::  ::  ::  ::  ui poke
      =/  eye  !<((pair @ta inbound-request:eyre) vaz)
      =/  jsn  (need (de:json:html ^-(@t q:(need body.request.q.eye))))
      ?:  ?=(%a -.jsn)
        ?.  &(?=(^ p.jsn) ?=(%n -.i.p.jsn) ?=(^ t.p.jsn) ?=(%n -.i.t.p.jsn))
          [~ homunculus-ego/!>(ego)]
        =.  urbs.ego  [(slav %ud p.i.p.jsn) (slav %ud p.i.t.p.jsn)]
        =^  vis=visa  arae.ego
          =/  aul=(set fons)  (snag cor.ego aula.ego)
          =/  kes=(list fons)  ~(tap in ~(key by arae.ego))
          =|  vis=visa
          |-  ^-  [visa arae]
          ?~  kes  [vis arae.ego]
          =/  aru=(unit ara)  (~(get by arae.ego) i.kes)
          ?~  aru  $(kes t.kes)
          =/  roo=(unit ens)  (~(get by esse.u.aru) ~[[%~ 0]])
          =/  gen=ara  (geno vela.u.aru ?^(roo [~ lar.u.roo] ~) u.aru)
          %=  $
            kes       t.kes
            arae.ego  (~(put by arae.ego) i.kes gen)
            vis       ?:((~(has in aul) i.kes) (~(uni by vis) visa.gen) vis)
          ==
        =.  q.luna.ego  (geno vela.q.luna.ego ~ q.luna.ego)
        =/  aru=(unit ara)  (~(get by arae.ego) fons.ego)
        =/  bac=visa  (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~])))
        :_  homunculus-ego/!>(ego)
        %:  neo-eyre-res
          our.bol
          p.eye
          %-  crip  %-  volo  ^-  lux  :-  %mor
          :~  (supo [1 x.urbs.ego 1 y.urbs.ego] ~ (~(uni by bac) vis))
              ?:  p.luna.ego
                =.(p.luna.ego | (supo muri.q.luna.ego ~ visa.q.luna.ego))
                (fero rex.q.luna.ego equi.q.luna.ego esse.q.luna.ego)
              ?~  aru
                (fero ~ ~ ~)
      ...
      =;  z=(unit zona)
        ...
        ?:  ?=(%esc -.u.z)
          ...
          :_  homunculus-ego/!>(ego)
          %+  welp
            ?:(p.luna.ego [(levo here.bol) ~] ~)
          %:  neo-eyre-res
            our.bol
            p.eye
            %-  crip  %-  volo  ^-  lux  :-  %mor
            :-  (supo [1 x.urbs.ego 1 y.urbs.ego] ~ vis)
            ?:  p.luna.ego
              :~  =.(p.luna.ego | (supo muri.q.luna.ego ~ visa.q.luna.ego))
                  (fero rex.q.luna.ego equi.q.luna.ego esse.q.luna.ego)
              ==
        ...
        ?:  p.luna.ego
          ...
          =/  avi=avis
            ?~  ales.q.luna.ego  ~
            =?  noa  &(?=(%txt -.u.z) ?=(^ p.u.z) ?=(~ t.p.u.z))
              [%chr i.p.u.z]
            (~(get by ^-(ales ales.q.luna.ego)) noa)
          ?^  avi
            :_  homunculus-ego/!>(ego)
            :~  :*  (snoc here.bol %umbra)
                    %poke  %homunculus-event
                    !>(^-(event.homunculus-api [%hotkey u.avi]))
            ==  ==
          =/  lek=(unit lex)  (~(get by omen.q.luna.ego) noa)
          ?~  lek  !!
          =^  crds  q.luna.ego
            =.(p.luna.ego | (muto our.bol p.eye u.lek u.z (snoc here.bol %umbra) q.luna.ego))
          [crds homunculus-ego/!>(ego)]
        ::
        ?:  ?&  ?=(%mod -.u.z)  ?=(%alt mod.u.z)  ?=(%txt -.key.u.z)
          ...
          :_  homunculus-ego/!>(ego)
          :~  :*  (snoc here.bol %umbra)
                  %poke  %homunculus-to-umbra
                  !>([%poke-key (slap !>(~) [%rock %ud (slav %ud ^-(@ i.p.key.u.z))])])
          ==  ==
        ::
        ?:  &(?=(%mod -.u.z) ?=(%alt mod.u.z) ?=(%aro -.key.u.z))
          ...
          =/  aru=(unit ara)  (~(get by arae.ego) fons.ego)
          =/  muf
            =/  au=(list fons)  ~(tap in (~(del in aul) fons.ego))
            |-  ^-  (list (pair muri fons))
            ?~  au  ~
            =/  ar=(unit ara)  (~(get by arae.ego) i.au)
            ?~  ar  $(au t.au)
          ...
          =.  cor.ego
            ?-  p.key.u.z
              %l  ?:(=(0 cor.ego) 0 (dec cor.ego))
              %r  ?:((lth +(cor.ego) (lent aula.ego)) +(cor.ego) cor.ego)
              %u  0
              %d  =/(l=@ (lent aula.ego) ?:(=(0 l) 0 (dec l)))
            ==
          ?:  =(cor.ego ocor)  !!
          =.  aul  (snag cor.ego aula.ego)
          =.  fons.ego  ?^(aul n.aul *fons)
          =.  aru  (~(get by arae.ego) fons.ego)
          =/  bac=visa  (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~])))
        ...
        ?:  &(?=(%mod -.u.z) |(?=(%shf mod.u.z) ?=(%ctl mod.u.z)) ?=(%aro -.key.u.z))
          ...
          =/  mur=muri  muri.u.aru
          =^  vis=visa  u.aru
            (fluo p.key.u.z ?:(?=(%shf mod.u.z) %full %char) fons.ego u.aru)
          =/  dim=muri
            :^    (min l.mur l.muri.u.aru)
                (max r.mur r.muri.u.aru)
              (min t.mur t.muri.u.aru)
        ...
        ?:  &(?=(%mod -.u.z) ?=(%alt mod.u.z) ?=(%txt -.key.u.z) =([~-c ~] p.key.u.z))
          ...
          =/  aru=(unit ara)  (~(get by arae.ego) fons.ego)
          ?~  aru  !!
          ?:  |((gth ~(wyt in aul) 1) =(1 (lent aula.ego)))
            =/  bac=visa  (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~])))
            =.  aul  (~(del in aul) fons.ego)
            =/  fonu=(unit fons)  ?^(aul [~ n.aul] ~)
            =/  arnu=(unit ara)  ?^(fonu (~(get by arae.ego) u.fonu) ~)
            :_  :-  %homunculus-ego
                !>
                %_  ego
                  aula  (snap aula.ego cor.ego aul)
                  arae  (~(del by arae.ego) fons.ego)
            ...
            %:  neo-eyre-res
              ...
              ==
            ==
          =:  arae.ego  (~(del by arae.ego) fons.ego)
              aula.ego  (oust [cor.ego 1] aula.ego)
              cor.ego   ?:(=(0 cor.ego) 0 (dec cor.ego))
            ==
          =.  aul  (snag cor.ego aula.ego)
          ...
          =/  arnu=(unit ara)  ?^(fonu (~(get by arae.ego) u.fonu) ~)
          =/  bac=visa  (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~])))
          :_  homunculus-ego/!>(ego(fons ?^(fonu u.fonu *fons)))
          %:  neo-eyre-res
            our.bol
            p.eye
            %-  crip  %-  volo  ^-  lux  :-  %mor
            :~  (supo [1 x.urbs.ego 1 y.urbs.ego] ~ (gyro ~(tap in aul) bac))
                ?~  arnu  (fero ~ ~ ~)
                (fero rex.u.arnu equi.u.arnu esse.u.arnu)
            ==
          ==
        ...
        =/  arf=$@(~ (pair ara fons))
          ...
          |-  ^-  $@(~ (pair ara fons))
          ?~  aul  ~
          =/  aru=(unit ara)  (~(get by arae.ego) i.aul)
          ?~  aru  $(aul t.aul)
          =/  roo=(unit ens)  (~(get by esse.u.aru) [[%~ 0] ~])
          ?~  roo  $(aul t.aul)
          =/  [x=@ud y=@ud]
        ...
        ?~  lek  !!
        =^  crds  p.arf  (muto our.bol p.eye u.lek u.z q.arf p.arf)
        :-  crds
        homunculus-ego/!>(ego(arae (~(put by arae.ego) q.arf p.arf), fons q.arf))
      ::
      ?~  inp  ~
      ?.  =('\\' i.inp)     [~ [%txt (tuba inp)]]
      ?~  t.inp             [~ [%txt ~[~-~5c.]]]
...
++  neo-eyre-res
  ...
  =/  head=sign:eyre:neo  [rid %head [200 ['Content-Type' 'text/plain'] ~]]
  =/  data=sign:eyre:neo  [rid %data [~ (as-octs:mimes:html dat)]]
...
++  orno                    :: position a new window in the current frame or in a new one (null case)
  |=  [mur=muri roo=ens]
  ^-  (unit loci)
  =/  murs=(list muri)  (peto ~(tap in ^-((set fons) (snag cor.ego aula.ego))))
  ?:  &((gte r.mur x.urbs.ego) (gte b.mur y.urbs.ego))
    ?^(murs ~ [~ [1 1]])
  =|  [movx=@ud movy=@ud]
  |-  ^-  (unit loci)
  =/  murv=muri
    [(add l.mur movx) (add r.mur movx) (add t.mur movy) (add b.mur movy)]
  ?:  (gth r.murv x.urbs.ego)
    ?:  (gth b.murv y.urbs.ego)  ~
    $(movx 0, movy +(movy))
  ?.  (abdo murv murs)
    [~ [l.murv t.murv]]
  $(movx +(movx))
...
++  fluo                    :: move a window in a given direction
  ...
  =/  mov=(unit loci)
    ?-  amo
        %full
      (meo fon dir muri.ara [1 x.urbs.ego 1 y.urbs.ego])
        %char
      %:  meo
        fon  dir  muri.ara
        :^    ?:((lte l.muri.ara 1) 1 (dec l.muri.ara))
            ?:((gte r.muri.ara x.urbs.ego) x.urbs.ego +(r.muri.ara))
          ?:((lte t.muri.ara 1) 1 (dec t.muri.ara))
        ?:((gte b.muri.ara y.urbs.ego) y.urbs.ego +(b.muri.ara))
      ==
    ==
  ?~  mov  [~ ara]
  =/  bac=visa
    (~(int by visa.ara) (rbox [1 1] urbs.ego =|(res -(size urbs.ego, look [~ ~ ~]))))
...
++  muto                    :: handle an event from the hotkey context
  |=  [orb=@p rid=@ta =lex zon=zona fon=fons =ara]
  |^  ^-  (quip card:neo ^ara)  novo
  ::
  ++  novo                  :: process an event update
    ...
    ?:  |(?=(%nav-l lex) ?=(%nav-r lex) ?=(%nav-u lex) ?=(%nav-d lex))
      ...
      ?:  |(?=(~ nex) ?=(~ sel) ?=(~ avis.u.sel))
        ~
      :~  [fon %poke %homunculus-event !>(^-(event.homunculus-api [%select u.avis.u.sel]))]
      ==
    ::
    ?:  ?=(%act lex)
      ?~  rex.ara  [~ ara]
      ...
      ?~  el  [~ ara]
      ?:  ?=(%input -.ars.u.el)  [~ ara]
      =/  fupd=$@(~ [opus =id.homunculus-api =data.homunculus-api])
      ...
      ?:  &(?=(~ fupd) ?=(~ cupd))
        ?~  avis.u.el  [~ ara]
        :_  ara
        :~  [fon %poke %homunculus-event !>(^-(event.homunculus-api [%act u.avis.u.el]))]
        ==
      =.  esse.ara
        ?^  fupd
      ...
      %+  welp
        (neo-eyre-res orb rid (crip (volo lux)))
      ?^  fupd
        :~  [fon %poke %homunculus-event !>(^-(event.homunculus-api [%form +.fupd]))]
        ==
      ?^  avis.u.el
        :~  [fon %poke %homunculus-event !>(^-(event.homunculus-api [%act u.avis.u.el]))]
        ==
    ...
    ?:  ?=(%clk lex)
      ...
      %+  welp
        %:  neo-eyre-res
          ...
          rid
          %-  crip  %-  volo  :-  %mor
          :~  (supo muri.ara visa.ara visa.duc)
              (fero rex.ara equi.ara esse.ara)
          ==
        ==
      ?~  avis.u.el  ~
      :~  [fon %poke %homunculus-event !>(^-(event.homunculus-api [%select u.avis.u.el]))]
      ==
    ::
    ?:  ?=(%inp lex)
      ?.  ?=(%txt -.zon)  [~ ara]
  ...
  ++  lego                  :: reset and collect the values of inputs under a form element
    |=  sk=rami
    ^-  [opus id.homunculus-api data.homunculus-api]
    =|  acc=[opus =id.homunculus-api =data.homunculus-api]
    =/  fk
      |-  ^-  $@(~ rami)
      ?~  t.sk  ~
    ...
    ?~  el
      ...
      acc
    ?:  &(?=(%form -.ars.u.el) =(~ id.acc))
      %=  $
        ager.i.fk  +(ager.i.fk)
        acc        $(fk [[%b 0] fk], id.acc ?~(avis.u.el '' u.avis.u.el))
      ==
    ?:  ?=(%input -.ars.u.el)
      ?~  avis.u.el
      ...
      =:  esse.acc  (~(put by esse.acc) fk u.el)
          visa.acc  (~(uni by visa.acc) visa.u.el)
          data.acc  (~(put by data.acc) u.avis.u.el val)
        ==
      $(ager.i.fk +(ager.i.fk), acc $(fk [[%b 0] fk]))
    ?:  ?=(%checkbox -.ars.u.el)
      ?~  avis.u.el
...
++  uro                     :: parse custom hotkey metadata to ales
  |=  h=(list [hotkey.homunculus-api id.homunculus-api])
  ^-  ales
  %-  malt
  |-  ^-  (list [nota @t])
  ?~  h  ~
...
++  supo                    :: make a display update
  ...
  =/  [x2=@ud y2=@ud]  [(min r.mur x.urbs.ego) (min b.mur y.urbs.ego)]
  =/  decl=@ud  (dec l.mur)
  =/  prex=@ud  decl
  :-  %mor
  :-  [%hop [x1 y1]]
  |-  ^-  (list lux)
  =/  v=(unit nodi)
    ?:  &(?=(~ old) !p.luna.ego)  (~(get by vis) [x1 y1])
    =/  nod=(unit nodi)  (~(get by vis) [x1 y1])
    ?~  nod  ~
    =/  lod=(unit nodi)  (~(get by old) [x1 y1])
    ?.  ?|  &(?=(^ lod) =(u.nod u.lod)) 
            &(p.luna.ego (~(has by visa.q.luna.ego) [x1 y1]))
        ==
      ?.  p.luna.ego  nod
      nod(b.p.u (cubo b.p.u.nod), f.p.u (cubo f.p.u.nod))
    ~
  ?:  =(x1 x2)
    ?:  =(y1 y2)
      ?~  v  ~
